...
# ═══════════════════════════════════════════════════════════════════════════
#  MEGALOVANIA LEVEL BUILDER  (shared by level 2 and level 3)
# ═══════════════════════════════════════════════════════════════════════════
def _build_megalovania_level(warn_beats):
    """
    ...
    warn_beats : 1 → 500 ms warn   (level 2)
                 2 → 1000 ms warn  (level 3)
    """
    ...
    # * = attacks center
    #
    #  u(RT,RB)        safe = RM               (3)  ← only non-center attack
    #  u(DM,DA)      * safe = (0,1)(1,0)(1,2)(2,1) (4)
    #  u(DM,DA,RT)   * safe = (1,0)(1,2)(2,1)  (3)
    #  u(DM,DA,RB)   * safe = (0,1)(1,0)(1,2)  (3)
    #  u(RT,RM)      * safe = RB               (3)
    #  u(DM,DA,CL)   * safe = (0,1)(1,2)(2,1)  (3)
    #  u(DM,DA,CR)   * safe = (0,1)(1,0)(2,1)  (3)
    #  u(RT,RB,CM)   * safe = (1,0)(1,2)       (2)
    #  u(CL,CR,RM)   * safe = (0,1)(2,1)       (2)
    #  u(DM,DA,CM)   * safe = (1,0)(1,2)       (2)
    p2a = [
        u(RT, RB),
        u(DM, DA),
        u(DM, DA, RT),
    ...
    # * safe squares are individual corner/side blocks, never center.
    #
    #  u(RT,RB,CM)      * safe = (1,0)(1,2)       sides  (2)
    #  u(CL,CR,RM)      * safe = (0,1)(2,1)       sides  (2)
    #  u(DM,DA,CM)      * safe = (1,0)(1,2)       sides  (2)
    #  u(RT,RB,DM)      * safe = (1,0)(1,2)       sides  (2)
    #  u(DM,DA,RT,CL)   * safe = (1,2)(2,1)       sides  (2)
    #  u(DM,DA,RB,CR)   * safe = (0,1)(1,0)       sides  (2)
    #  u(DM,DA,RT,CR)   * safe = (1,0)(2,1)       sides  (2)
    #  u(DM,DA,RB,CL)   * safe = (0,1)(1,2)       sides  (2)
    #  u(RT,RB,CM,CR)   * safe = (1,0)            side   (1)
    #  u(RT,RB,CM,CL)   * safe = (1,2)            side   (1)
    #  u(RB,RM,CL,CR)   * safe = (0,1)            side   (1)
    #  u(RT,RM,CL,CR)   * safe = (2,1)            side   (1)
    #  u(RB,RM,CR,CM)   * safe = (0,0)            corner (1)
    #  u(RB,RM,CL,CM)   * safe = (0,2)            corner (1)
    #  u(RT,RM,CR,CM)   * safe = (2,0)            corner (1)
    #  u(RT,RM,CL,CM)   * safe = (2,2)            corner (1)
    p2b = [
        u(RT, RB, CM),
        u(CL, CR, RM),
        u(DM, DA, CM),
...
LEVELS = [
    {
        ...
        'data':     _build_megalovania_level(warn_beats=1),
    },
    {
        ...
        'bpm':      120,
        'music':    'Megalovania.ogg',
        'data':     _build_megalovania_level(warn_beats=2),
    },
    {
        'name':     '[[BIG SHOT]]',
